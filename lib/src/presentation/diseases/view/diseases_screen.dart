...
import 'package:medvisual/src/presentation/diseases/widgets/widgets.dart';
...
class _DiseasesScreenState extends State<DiseasesScreen> {
  ...
  // Bloc init
  final _diseasesListBloc = GetIt.I<DiseasesBloc>();
  //Scroll Controller
          ...
          if (state is DiseasesListLoaded || _diseasesList.isNotEmpty) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                if (index == _diseasesList.length - 1 &&
                    state is DiseasesListLoading) {
                  return Center(
